...
public class ReponseController {
    ...
    public void updateReponse(@PathVariable("reponsesNumero") Integer numero,
            @RequestParam(required = false) String texte, @RequestParam(required = false) Boolean valeur) {
